...
## **Fase 3: Gestione dello Stato e Persistenza dei Dati**
...
## **Fase 4: Hand-Tracking e Interazioni Base**
...
* Sviluppare la manipolazione globale del "Garden Group" (Move, Rotate, Scale) permettendo all'utente di posizionare l'esperienza sulla superficie scelta tramite l'Hit-Testing della Fase 2.
* Gestire le collisioni visive (bounding box) dei polpastrelli.

## **Fase 5: Generazione Procedurale degli Asset (Ambiente Base)**
